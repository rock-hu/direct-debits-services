package com.openbanking.direct.debits.controller;

import com.openbanking.direct.debits.model.OBReadDirectDebit2;
...
public interface AccountsApi {
	...
	@Operation(summary = "Get Direct Debits", operationId = "getAccountsAccountIdDirectDebits", description = "", tags = { "Direct Debits", })

	@RequestMapping(
			value = "/accounts/{AccountId}/direct-debits",
			produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" },
			method = RequestMethod.GET)
	default ResponseEntity<OBReadDirectDebit2> getAccountsAccountIdDirectDebits(@Parameter(name = "AccountId", required = true)
